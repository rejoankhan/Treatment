...
public class DisLiverActivity extends AppCompatActivity {
    ListView listViewLiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dis_liver);
        listViewLiver = findViewById(R.id.listViewLiver);
        ...
        hashMap.put("callText", " সিরাসরি সিরিয়াল দিতে হবে -ফোনে সিরিয়াল নেওয়া হয় না");
        ...
        listViewLiver.setAdapter(myAdapter);
